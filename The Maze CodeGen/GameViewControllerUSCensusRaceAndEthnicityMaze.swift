...
@available(iOS 13.0, *)
class GameViewControllerUSCensusRaceAndEthnicityMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsUSCensusRaceAndEthnicity"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsUSCensusRaceAndEthnicity", modeName: "US Race and Ethnicity")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneUSCensusRaceAndEthnicityMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneUSCensusRaceAndEthnicityMaze(size: view.bounds.size)
