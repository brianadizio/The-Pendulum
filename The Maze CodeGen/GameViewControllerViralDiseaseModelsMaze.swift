...
@available(iOS 13.0, *)
class GameViewControllerViralDiseaseModelsMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsViralDiseaseModels"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsViralDiseaseModels", modeName: "Viral Disease Models")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneViralDiseaseModelsMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneViralDiseaseModelsMaze(size: view.bounds.size)
