...
@available(iOS 13.0, *)
class GameViewControllerNeuralDiseaseModelsMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsNeuralDiseaseModels"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsNeuralDiseaseModels", modeName: "Neural Disease Models")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneNeuralDiseaseModelsMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneNeuralDiseaseModelsMaze(size: view.bounds.size)
