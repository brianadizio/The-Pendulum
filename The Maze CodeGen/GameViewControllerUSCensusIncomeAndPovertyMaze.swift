...
@available(iOS 13.0, *)
class GameViewControllerUSCensusIncomeAndPovertyMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsUSCensusIncomeAndPoverty"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsUSCensusIncomeAndPoverty", modeName: "US Income and Poverty")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneUSCensusIncomeAndPovertyMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneUSCensusIncomeAndPovertyMaze(size: view.bounds.size)
