...
@available(iOS 13.0, *)
class GameViewControllerAnimalGeneExpressionMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsAnimalGeneExpression"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsAnimalGeneExpression", modeName: "Animal Gene Expression")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneAnimalGeneExpressionMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneAnimalGeneExpressionMaze(size: view.bounds.size)
