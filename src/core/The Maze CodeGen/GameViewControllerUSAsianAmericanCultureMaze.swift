...
@available(iOS 13.0, *)
class GameViewControllerUSAsianAmericanCultureMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsUSAsianAmericanCulture"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsUSAsianAmericanCulture", modeName: "Asian American Culture")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneUSAsianAmericanCultureMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneUSAsianAmericanCultureMaze(size: view.bounds.size)
