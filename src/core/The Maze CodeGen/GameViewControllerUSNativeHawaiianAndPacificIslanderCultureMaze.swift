...
@available(iOS 13.0, *)
class GameViewControllerUSNativeHawaiianAndPacificIslanderCultureMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsUSNativeHawaiianAndPacificIslanderCulture"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsUSNativeHawaiianAndPacificIslanderCulture", modeName: "Native Hawaiian And Pacific Islander American Culture")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneUSNativeHawaiianAndPacificIslanderCultureMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneUSNativeHawaiianAndPacificIslanderCultureMaze(size: view.bounds.size)
