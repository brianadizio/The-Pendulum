...
@available(iOS 13.0, *)
class GameViewControllerHumanGeneExpressionMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsHumanGeneExpression"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsHumanGeneExpression", modeName: "Human Gene Expression")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneHumanGeneExpressionMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneHumanGeneExpressionMaze(size: view.bounds.size)
