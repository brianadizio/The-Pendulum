...
@available(iOS 13.0, *)
class GameViewControllerHumanProteinFoldingMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsHumanProteinFolding"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsHumanProteinFolding", modeName: "Human Protein Folding")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneHumanProteinFoldingMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneHumanProteinFoldingMaze(size: view.bounds.size)
