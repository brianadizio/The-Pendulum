...
@available(iOS 13.0, *)
class GameViewControllerUSWhiteAmericanCultureMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsUSWhiteAmericanCulture"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsUSWhiteAmericanCulture", modeName: "White American Culture")
    loadInitMetrics()
  ...
  override func viewDidLoad() {
    ...
    //    print(view)
      ...
      let scene = GameSceneUSWhiteAmericanCultureMaze(size: temp)
    ...
    self.view.addSubview(swipingButton)
      ...
      /* if scene.isSolved()==1 {
       let scene=GameSceneUSWhiteAmericanCultureMaze(size: view.bounds.size)
