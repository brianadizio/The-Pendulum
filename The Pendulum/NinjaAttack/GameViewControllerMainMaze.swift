...
@available(iOS 13.0, *)
class GameViewControllerMainMaze: UIViewController {
...
//        self.view = UIView(frame: UIScreen.main.bounds)
  ...
  let EnSoString = "MetricsImmersedCircle"
  var InitMetrics: [NSManagedObject] = []
  
  override func viewDidAppear(_ animated: Bool) {
    saveMode(mode: "MetricsImmersedCircle", modeName: "Immersed Circle")
    loadInitMetrics()
